...
docker cp ./config-leaf1.js clab-srl02-leaf1:/home/admin/.
docker exec clab-srl02-leaf1 sr_cli --candidate-mode --commit-at-end -- load file /home/admin/config-leaf1.js
docker cp ./config-border.js clab-srl02-border:/home/admin/.
docker exec clab-srl02-border sr_cli --candidate-mode --commit-at-end -- load file /home/admin/config-boder.js
for i in {30,20,21}; do scp nmcli_*_con.sh root@172.20.20.$i:/root/. ; done
for j in {30,20,21};
do
